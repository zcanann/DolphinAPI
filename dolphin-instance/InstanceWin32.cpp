...
{
public:
    InstanceWin32(const InstanceBootParameters& bootParams);
...
InstanceWin32::InstanceWin32(const InstanceBootParameters& bootParams) : Instance(bootParams)
{
}
...
std::unique_ptr<Instance> Instance::CreateWin32Instance(const InstanceBootParameters& bootParams)
{
    return std::make_unique<InstanceWin32>(bootParams);
}
